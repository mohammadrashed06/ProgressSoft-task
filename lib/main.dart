...
import 'package:progress_soft_task/blocs/auth/register/register_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: MaterialApp(
        ...
        home: FirebaseAuth.instance.currentUser == null ? const SplashScreen() : const MainScreen(),
        routes: {
